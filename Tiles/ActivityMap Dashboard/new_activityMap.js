...
angular.module('APP', ['ngAnimate'])
    .controller('MainCtrl', ['$scope', '$http', '$window', '$rootScope', 'CommonService', function ($scope, $http, $window, $rootScope, CommonService) {
        ...
        $scope.getConstituentDetails = function (filter) {
            ...
            retrieveReq.onreadystatechange = function () {
                if (retrieveReq.readyState == 4 && retrieveReq.status == 200) {
                    ...
                    $scope.displayConstituentPushpinsOnMap($scope.constituentDetails, filter);
        ...
        $scope.displayConstituentPushpinsOnMap = function (constituentDetails, filter) {
            ...
            $scope.thisMonthRegisteredConstituents = _.filter(constituentDetails, function (o) {
